---
title: "`r siteCursoR::pegar_info_curso(1, 'title')`"
data: "`r siteCursoR::pegar_data_curso(1)`"
hora: "`r siteCursoR::pegar_carga_horaria(1)`"
local: "`r siteCursoR::pegar_info_turma(1, 'local')`"
img: "`r siteCursoR::pegar_info_curso(1, 'img')`"
preco: "`r siteCursoR::pegar_preco(1)`"
banner: "`r siteCursoR::pegar_info_curso(1, 'banner')`"
desc: "`r siteCursoR::pegar_info_curso(1, 'desc')`"
ordem: "`r siteCursoR::pegar_info_curso(1, 'ordem')`"
id: "`r as.character(siteCursoR::pegar_info_turma(1, 'curso_id'))`"
aberto: "`r siteCursoR::verificar_turma_aberta(1)`"
unit_price: "`r format(siteCursoR::pegar_info_turma(1, 'valor'), scientific = FALSE)`"
---
