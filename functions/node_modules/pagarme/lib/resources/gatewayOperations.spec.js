...
test('client.gatewayOperations.refuseMessage', () =>
  runTest({
    ...
    url: '/subscriptions/4321/operations/1234/refuse_message',
    method: 'GET',
    body: {
      api_key: 'abc123',
    },
