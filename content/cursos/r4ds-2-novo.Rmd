---
title: "`r siteCursoR::pegar_info_curso(3, 'title')`"
data: "de 17 de agosto a 02 de setembro de 2020, segundas e quartas, das 19h às 22h."
hora: "Dezoito horas de curso"
local: "Aulas online"
img: "`r siteCursoR::pegar_info_curso(3, 'img')`"
preco: "R$ 500,00"
banner: "`r siteCursoR::pegar_info_curso(3, 'banner')`"
desc: "`r siteCursoR::pegar_info_curso(3, 'desc')`"
professores: ["Caio Lente", "William Amorim"]
ordem: "`r siteCursoR::pegar_info_curso(3, 'ordem')`"
id: 25
aberto: "true"
---
...
```{r}
shiny::hr()
siteCursoR:::criar_section_header("O que vamos ver?")
```
...
```{r}
shiny::hr()
siteCursoR:::criar_section_header("Quais são os pré-requisitos?") 
```
