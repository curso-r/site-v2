...
Depois de registrar o seu app você receberá um *client ID* e um *client secret*. Em teoria o *client ID* é informação pública e o *client secret* não pode ser divulgado. Na prática, como em alguns casos não é possível esconder o *client secret*, não é muito importante escondê-la. Em alguns o *client secret* nem é criado (no Auth0 ele é criado).

### O fluxo da autenticação

Existem 4 fluxos distintos de autenticação no OAuth2.0. No nosso caso vamos usar um método chamado de * Authorization Code*. Esse método funciona da seguinte forma:

1) Criamos um link de autenticação para o usuário com as seguintes informações:
...
![](https://camo.githubusercontent.com/f5f44dbf0abc7642d83fe366e97f29fdd3233d9e/68747470733a2f2f6161726f6e70617265636b692e636f6d2f6f617574682d322d73696d706c69666965642f6f617574682d617574686f72697a6174696f6e2d70726f6d70742e706e67)
...
Na próxima tela, dê um nome para o app (esse é o nome que aparecerá na página de login) e selecione o *Single Page Application*. Selecionamos esse tipo de app para não ter que se preocupar em esconder o *client secret*.
