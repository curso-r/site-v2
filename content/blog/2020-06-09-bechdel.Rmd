...
O [Teste de Bechdel](https://pt.wikipedia.org/wiki/Teste_de_Bechdel) avalia se um filme possui três regras básicas:
...
A base trás informação de premiações. Filmes sem premiação não destoa dos filmes premiados em termos de avaliação de Bechdel, o que indica que o machismo não justifica o sucesso de um filme.
...
bechdel_nota_por_decada %>% 
  ...
  labs(x = "Década", y = "Nota IMDB", colour = "Passou no\nTeste", fill = "Passou no\nTeste", title = "Notas do IMDB vs Teste de Bechdel")
```
