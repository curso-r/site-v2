...
A Figura \@ref(fig:roll) mostra os resultados da análise considerando uma janela de 2 anos. Considerei no gráfico somente os 5 artistas com mais visualizações. Nesse gráfico é possível visualizar que Rafael Portugal está dominando as visualizações desde que entrou. No entanto, recentemente a diferença entre os cinco artistas está diminuindo. Uma possível explicação é que, como a quantidade de visualizações dos vídeos estacionou na média da Figura \@ref(fig:historico)

```{r, fig.cap="Gráfico do volume acumulado de visualizações por artista ao longo do tempo, considerando uma janela de 2 anos.", eval=TRUE, echo=FALSE}
