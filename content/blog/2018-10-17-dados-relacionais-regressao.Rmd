...
```{r}
criar_variaveis_explicativas <- function(don, donnors, t0) {
  ...
  don %>% 
    ...
    summarise(
      ...
      qtd_doacoes_1 = n_distinct(donation_id[donation_received_date > t0 - months(12)]),
      qtd_doacoes_2 = n_distinct(donation_id[donation_received_date > t0 - months(24)]),
      
      qtd_projetos_1 = n_distinct(project_id[donation_received_date > t0 - months(12)]),
      qtd_projetos_2 = n_distinct(project_id[donation_received_date > t0 - months(24)]),
      
      vl_doado_1 = sum(donation_amount[donation_received_date > t0 - months(12)]),
      vl_doado_2 = sum(donation_amount[donation_received_date > t0 - months(24)]),
      
      prop_doacao_opt = mean(donation_included_optional_donation == "Yes"),
